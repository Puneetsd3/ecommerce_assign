...
SECRET_KEY = 'django-insecure-634*hp2#m@(ne^6#+nh4z*&r(8u!w#b&hm3=uyfd$*5d+0q-5b'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.sqlite3'),  # Use os.path.join for correct path handling
    }
}
